...
app.post('/add_bandeja_entrada', verificarToken, (req, res) => {
    let body = req.body
...
app.post('/add_bandeja_salida', verificarToken, (req, res) => {
    let body = req.body
...
app.get('/bandeja-recibida/:id', verificarToken, (req, res) => {
...
app.get('/bandeja-emitida/:id', verificarToken, (req, res) => {
    let id = req.params.id
...
app.post('/rechazar_tramite', verificarToken, (req, res) => {
...
app.post('/aceptar_tramite', verificarToken, (req, res) => {
